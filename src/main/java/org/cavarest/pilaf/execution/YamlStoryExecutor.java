 ...
 */
public class YamlStoryExecutor {

    private final TestConfiguration config;
    private final TestReporter reporter;
    private final YamlStoryParser parser;

    public YamlStoryExecutor(TestConfiguration config, TestReporter reporter) {
        this.config = config;
    ...
    private boolean executeActions(List<Action> actions, String phase, TestResult result) {
        ...
        for (int i = 0; i < actions.size(); i++) {
            ...
            String actionDesc = action.getName() != null ? action.getName() : action.getType().toString();
